...
export default function AppLayout() {
  ...
  // Reset the sidebar state when screen size changes
  useEffect(() => {
    if (!isMobile) {
      ...
      items: [
        {
          ...
          doc: "Strategic summaries",
        },
        {
          name: "Opportunities",
          path: "/opportunities",
          icon: Target,
          doc: "Elasticsearch tenders",
        },
        {
          name: "Predictive Forecasts",
          path: "/reports",
          icon: Activity,
          doc: "Upcoming budget listings",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          path: "/organizations",
          icon: Landmark,
          doc: "Authority rosters",
        },
        {
          name: "Suppliers Directory",
          path: "/suppliers",
          icon: Users,
          doc: "Constractor registries",
        },
        {
          name: "Consortium Builder",
          path: "/partnerships",
          icon: Handshake,
          doc: "Joint-Venture escrow",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "AI Copilot Desk",
          path: "/intelligence?tab=copilot",
          icon: Bot,
          doc: "Gemini compliance desk",
        },
        {
          name: "Relationship Graph",
          path: "/intelligence?tab=graph",
          icon: Network,
          doc: "Interconnect patterns",
        },
        {
          name: "FREIGHT CORRIDOR MAPS",
          path: "/intelligence?tab=map",
          icon: Map,
          doc: "Geospatial freight tracks",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: User,
          doc: "Upload ISO certificates",
        },
        {
          name: "Subscription Bench",
        ...
        },
        {
          ...
          icon: UserCheck,
          doc: "Collaborative permissions",
        },
        {
          name: "ER PostgreSQL Index",
  ...
  return (
    <div className="bg-slate-950 text-slate-100 min-h-screen font-sans antialiased selection:bg-[#FF6321] selection:text-black flex flex-col">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1
                  className="text-sm font-bold uppercase tracking-widest text-[#fafafa] cursor-pointer"
                  onClick={() => navigate("/dashboard")}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <div className="bg-slate-950 border border-slate-850 py-1 px-2.5 rounded-lg flex items-center gap-1.5 focus-within:border-[#FF6321]">
              ...
              <select
                ...
                <option value="Guest" className="bg-slate-950 text-white">
                  Guest / Free
                </option>
                <option value="SME User" className="bg-slate-950 text-white">
                  SME User
                </option>
                <option
                ...
                <div className="absolute right-0 mt-2.5 w-80 bg-slate-900 border-2 border-slate-800 rounded-xl shadow-2xl z-50 p-4 font-mono text-xs text-slate-300 space-y-3">
                  ...
                  <div className="space-y-2.5 max-h-48 overflow-y-auto pr-1">
                    <div className="p-2 bg-slate-950 rounded border border-rose-950/50">
                      <span className="text-[8px] text-rose-400 font-bold block uppercase border-b border-slate-900 pb-0.5 mb-1">
                        CRITICAL REGISTER CHECK
                      </span>
                      <p className="text-[10px] leading-snug">
                        Kampala solar installation bid Award completed on UNRA
                        framework code UG-2844.
                      </p>
                    </div>
                    <div className="p-2 bg-slate-950 rounded border border-[#FF6321]/30">
                      <span className="text-[8px] text-amber-400 font-bold block uppercase border-b border-slate-900 pb-0.5 mb-1">
                        SOVEREIGN GRAPH SYNC
                      </span>
                      <p className="text-[10px] leading-snug">
                        Tanzanian maize milling tenders increased by +25% in
                        planned fiscal cycle.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto flex flex-col md:flex-row relative">
        ...
        <aside
          className={`bg-slate-900/60 border-r border-slate-900 md:w-64 w-full flex-none p-4 space-y-6 md:block ${!isMobile ? "hidden" : "block"}`}>
          <div className="flex justify-between items-center md:hidden border-b border-slate-850 pb-2 mb-2">
            ...
            <button
              ...
              className="p-1 uppercase font-bold font-mono text-slate-500 hover:text-white cursor-pointer transition">
              {sidebarCollapsed ? <MenuIcon className="h-4 w-4" /> : "close ×"}
            </button>
          </div>
              ...
              <div key={grp.title} className="space-y-2">
                ...
                <div className="flex flex-col gap-1">
                  {grp.items.map((item) => {
                    ...
                    const isIntelActive =
                      item.path.startsWith("/intelligence") &&
                    ...
                    return (
                      <NavLink
                        ...
                        <div className="flex flex-col text-left">
                          <span>{item.name}</span>
                          <span className="text-[8px] text-slate-500 scale-90 origin-left tracking-normal truncate">
                            {item.doc}
                          </span>
                        </div>
                      </NavLink>
            ...
            <div className="bg-slate-900 border-2 border-[#302010] rounded-xl p-8 max-w-2xl mx-auto my-12 text-center space-y-6 relative overflow-hidden font-sans">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-400 max-w-lg mx-auto leading-relaxed">
                  Your current assigned licensing seat{" "}
                  <strong className="text-[#FF6321] uppercase">
                    ({activeRole})
                  </strong>{" "}
                  has limited compliance authorizations. Unlock the{" "}
                  <strong className="text-[#FF6321] uppercase">
                    [{getRequiredTier(location.pathname)}]
                  </strong>{" "}
                  to use these relational graphs, indices data sheets, and AI
                  predictive modules.
                </p>
              </div>
              ...
              <div className="bg-slate-950 p-4 border border-slate-850 rounded-xl max-w-md mx-auto text-[11px] font-mono text-slate-400 text-left space-y-2">
                <div className="flex gap-2 items-center text-emerald-400">
                  <CheckCircle className="h-3.5 w-3.5" /> High-probability
                  consortium mapping unlocks.
                </div>
                <div className="flex gap-2 items-center text-emerald-400">
                  <CheckCircle className="h-3.5 w-3.5" /> Access unmasked
                  competitor bid values.
                </div>
                <div className="flex gap-2 items-center text-emerald-400">
                  <CheckCircle className="h-3.5 w-3.5" /> Synchronize Unlimited
                  team nodes.
                </div>
              </div>
      ...
      <footer className="border-t border-slate-800/80 bg-slate-900 py-4 px-6 text-[10px] font-mono text-slate-500 relative z-30 flex-none">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-wrap gap-4 items-center justify-center">
            <span>
              SYNC STATUS:{" "}
              <span className="text-[#00FF00] font-semibold">ONLINE</span>
            </span>
            <span className="text-slate-805">|</span>
            <span>
              SYSTEM TIME:{" "}
              <span className="text-[#FF6321] font-bold">{systemTime}</span>
            </span>
            <span className="text-slate-805">|</span>
            <span className="text-slate-400">
              Uganda, Kenya, Tanzania, Rwanda, South Sudan, DRC procurement
              networks linked.
            </span>
          </div>
          <div className="flex flex-wrap gap-4 items-center justify-center">
            <span className="hover:text-[#FF6321] cursor-pointer transition-colors uppercase tracking-wider text-[9px] font-bold">
              WAF Protected
            </span>
            <span className="text-slate-805">|</span>
            <span className="hover:text-[#FF6321] cursor-pointer transition-colors uppercase tracking-wider text-[9px] font-bold">
              OECD compliance rules
            </span>
            <span className="text-slate-805">|</span>
